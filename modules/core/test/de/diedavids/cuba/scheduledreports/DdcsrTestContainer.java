...
public class DdcsrTestContainer extends TestContainer {

    public DdcsrTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/cuba/scheduledreports/app.properties",
    ...
    public static class Common extends DdcsrTestContainer {

        public static final DdcsrTestContainer.Common INSTANCE = new DdcsrTestContainer.Common();
